...
export interface ApiDireccionDireccion extends Schema.CollectionType {
  ...
  attributes: {
    titulo: Attribute.String & Attribute.Required;
    calle: Attribute.String & Attribute.Required;
    ciudad: Attribute.String & Attribute.Required;
    estado: Attribute.String & Attribute.Required;
    codigo_postal: Attribute.String & Attribute.Required;
...
export interface ApiPedidoPedido extends Schema.CollectionType {
  ...
  attributes: {
    ...
    idPago: Attribute.String & Attribute.Required;
    direccion: Attribute.JSON & Attribute.Required;
    productos: Attribute.JSON & Attribute.Required;
    slug: Attribute.UID<'api::pedido.pedido', 'idPago'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::pedido.pedido',
